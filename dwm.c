...
/* External declarations for colors defined in config.h and dwm.c (REQUIRED FIX) */
...
// --- CRITICAL LINE FOR THE XRDB RELOAD LOOP ---
extern Clr **scheme;
...
tile(Monitor *m)
{
	...
	if (smartgaps == n) {
		oe = 0; /* outer gaps disabled when smartgaps == n */
	}
